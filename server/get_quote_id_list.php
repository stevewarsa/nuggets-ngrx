...
$results = $db->query("SELECT o.objection_id, approved, sent_from_user FROM common_objection o, common_objection_answer oa where o.objection_id = oa.objection_id and objection_category = 'quote' and answer_id = 1");
$arrayName = array();
